...
from expenses.forms import InvestmentForm, BrokerForm, InvestmentTypeForm


class InvestmentListView(LoginRequiredMixin, ListView):
    model = Investment
    template_name = 'expenses/investment/investment_list.html'  # Updated template path
...
class InvestmentCreateView(LoginRequiredMixin, CreateView):
    model = Investment
    template_name = 'expenses/investment/investment_form.html'  # Updated template path
    form_class = InvestmentForm
    success_url = reverse_lazy('investments:investment_list')  # Updated namespace
...
class InvestmentDeleteView(LoginRequiredMixin, DeleteView):
    model = Investment
    template_name = 'expenses/investment/investment_confirm_delete.html'  # Updated template path
    success_url = reverse_lazy('investments:investment_list')  # Updated namespace
...
class BrokerListView(LoginRequiredMixin, ListView):
    model = Broker
    template_name = 'expenses/investment/broker_list.html'  # Updated template path
...
class BrokerCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'expenses/investment/broker_form.html'  # Updated template path
    success_url = reverse_lazy('investments:broker_list')  # Updated namespace
...
class BrokerDeleteView(LoginRequiredMixin, DeleteView):
    model = Broker
    template_name = 'expenses/investment/broker_confirm_delete.html'  # Updated template path
    success_url = reverse_lazy('investments:broker_list')  # Updated namespace
...
class InvestmentTypeListView(LoginRequiredMixin, ListView):
    ...
    template_name = 'expenses/investment/investment_type_list.html'  # Updated template path
...
class InvestmentTypeCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'expenses/investment/investment_type_form.html'  # Updated template path
    success_url = reverse_lazy('investments:investment_type_list')  # Updated namespace
...
class InvestmentTypeDeleteView(LoginRequiredMixin, DeleteView):
    model = InvestmentType
    template_name = 'expenses/investment/investment_type_confirm_delete.html'  # Updated template path
    success_url = reverse_lazy('investments:investment_type_list')  # Updated namespace