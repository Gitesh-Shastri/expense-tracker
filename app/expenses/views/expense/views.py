...
from expenses.models import Expense, Category, Bank
...
class MonthlyExpenseView(LoginRequiredMixin, ListView):
    model = Expense
    template_name = 'expenses/expense/monthly_expenses.html'  # Updated template path
...
class ExpenseCreateView(LoginRequiredMixin, CreateView):
    model = Expense
    template_name = 'expenses/expense/expense_form.html'  # Updated template path
...
class ExpenseDeleteView(LoginRequiredMixin, DeleteView):
    model = Expense
    template_name = 'expenses/expense/expense_confirm_delete.html'  # Updated template path
    success_url = reverse_lazy('expenses:monthly_expenses')
